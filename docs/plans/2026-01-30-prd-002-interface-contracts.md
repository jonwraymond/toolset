# PRD-002 Interface Contracts — toolset
...
| --- | --- | --- |
| `Policy` | `toolset/policy.go:6` | Allow(tool *tooladapter.CanonicalTool) bool |
| `Registry` | `toolset/builder.go:10` | Tools() []*tooladapter.CanonicalTool |
